package tool.demo.javapack.javaweb.hz;
 ...
 * @version:V1.0
 */
public class ChangeLogUtilHZ {

    // 指向工程所在的根目录,以/结尾
    static String WEBAPPS = "E:\\project\\code\\work\\hzkf20190625\\artifacts\\";
    //	// 工程名
//	static String PROJECT = "gpms";
    // 代码编译后目录
//	static String DEPLOY_DIR = "G:/work/BJworkspace/01trunk/agentlib/out/artifacts";// class类目录
    // 指向changeLog文件
    static String CHANGE_LOG_FILE_NAME = "E:\\project\\desktop\\changelog-hz.txt";
    static String CUTSVN = "/fz/";//不同SVN路径下不需要的前缀
    // 增量包目录，后面将会自动创建以最新SVN版本号作为名称的文件夹
    // 注意变更标签版本号（这里用日期）
    static String OTARGET = "E:\\project\\desktop\\杭州监管系统待办任务";// 补丁包存放的地址
...
//			if (line.contains(PROJECT)) {// 单行全文搜索
            ...
            filePath=filePath.replaceAll("-module","");
//				replaceAll(str[0],str[0]+"_war_exploded")..replaceAll("gpms","gpms_war_exploded").replaceAll("-module","");
