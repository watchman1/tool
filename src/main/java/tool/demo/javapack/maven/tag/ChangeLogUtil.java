...
public class ChangeLogUtil {
	...
	// 指向工程所在的根目录,以/结尾
	static String WEBAPPS = "E:\\project\\code\\work\\nmtag4.2.0.2artifacts\\artifacts\\";
//	// 工程名
//	static String PROJECT = "gpms";
	// 代码编译后目录
//	static String DEPLOY_DIR = "G:/work/BJworkspace/01trunk/agentlib/out/artifacts";// class类目录
	// 指向changeLog文件
	static String CHANGE_LOG_FILE_NAME = "E:\\project\\desktop\\changelog-V4.2.0.2_nm_gpmanage_build_20190906-tag-1.txt";
	static String CUTSVN = "/02code/02branches/nm_4.2_tags/nmtab-V4.2.0.2_nm_gpmanage_build_20190906/11trunk/";//不同SVN路径下不需要的前缀
	static boolean mavenflag = true;//是否maven项目
	// 增量包目录，后面将会自动创建以最新SVN版本号作为名称的文件夹
	// 注意变更标签版本号（这里用日期）
	static String OTARGET = "E:\\project\\desktop\\内蒙监管V4.2.0.2_nm_gpmanage_build_20190906-tag-单一来源公示";// 补丁包存放的地址
